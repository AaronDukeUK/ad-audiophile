...
export default function Footer() {
  ...
  `
  const { data: strapi, loading, error } = useQuery(FOOTER)
  ...
  return (
    <div className="footer">
      ...
      <p className="footer__body">
        {strapi.siteData.data.attributes.FooterText}
      </p>
      <p className="footer__copyright">
        {strapi.siteData.data.attributes.CopyText}
      </p>
      <div className="footer__social">
        <a className="footer__sociallink" href="#">
